Nota: Para esta preentrega se implementó la base de datos RetailPro siguiendo el modelo relacional definido en las preentregas 1 y 2, ya que la consigna del Módulo 5 requiere entidades y atributos (Clientes, Productos, Territorios, Segmento, Región y Canal) que no forman parte de la base simplificada utilizada en la Preentrega 3.
